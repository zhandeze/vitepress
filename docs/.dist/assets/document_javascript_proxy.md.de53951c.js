import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.f5532599.js";const d=JSON.parse('{"title":"proxy的使用方法","description":"","frontmatter":{"title":"proxy的使用方法","isTimeLine":true,"date":"2021-08-13T14:03:48.000Z"},"headers":[],"relativePath":"document/javascript/proxy.md","filePath":"document/javascript/proxy.md"}'),p={name:"document/javascript/proxy.md"},o=l(`<h3 id="handlers-get" tabindex="-1">handlers.get <a class="header-anchor" href="#handlers-get" aria-label="Permalink to &quot;handlers.get&quot;">​</a></h3><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">animal</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> {</span></span>
